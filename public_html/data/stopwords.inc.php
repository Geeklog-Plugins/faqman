...
// This file contains an array of the complete default MySQL stop list,
// there are 570 words. Editing this list WILL NOT remove them from the
// stop list, so they still cannot be used in searches, the only way to do
// that is to edit the MySQL source file myisam/ft_static.c and then recompile MySQL
//
// This is NOT my fault, so please do not email me about it, but if you know any easier
// way to get the MySQL stoplist please let me know
