...
// +---------------------------------------------------------------------------+
// | FAQ Man Plugin Install.php                                                |
// | This program creates the required table structure and core Geeklog        |
// | database updates to complete installation of this plugin                  |
// +---------------------------------------------------------------------------+
...
require_once $_CONF['path'] . 'plugins/faqman/functions.inc';
...
$pi_version      = '0.8.1';
$gl_version      = '1.5.0';
$pi_url          = 'http://www.portalparts.com';
...
$FEATURES = array();
$FEATURES['faqman.edit'] = 'FAQ Manager Admin';
$FEATURES['faqman.user'] = 'FAQ Manager Viewer';

$MAPPINGS = array();
$MAPPINGS['faqman.edit']     = array($pi_admin);
$MAPPINGS['faqman.user']     = array($pi_admin);
...
{
    if (!function_exists('PLG_upgrade')) {
        return false;
    }
